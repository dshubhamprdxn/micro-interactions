...
t1.to(switchHTMLElement, {width: "80px", duration: 0.4, onComplete: changeMessage, onCompleteParams: [1, 2], onReverseComplete: changeSwitchValue})
    .to(switchHTMLElement, {backgroundColor: "grey", ease: "linear", duration: 0.4, onReverseComplete: changeMessage, onReverseCompleteParams: [2, 1]}, "<")
    .to(switchInteractionMainDiv, {backgroundColor: "lightblue", ease: "linear", duration: 0.4, onComplete: playT2}, "<")
    .set(fill, {border: ""})
    .set(fill, {borderTopColor: "transparent"});

t2.set(fill, {border: "6px solid grey", borderRadius: "50%", delay: 0.1})
...
t3.set(fill, {border: ""})
    .set(fill, {borderTopColor: "transparent"})
    .to(switchHTMLElement, {width: "150px", duration: 0.4, onComplete: changeMessage, onCompleteParams: [2, 3], onReverseComplete: playT4})
    .to(switchInteractionMainDiv, {backgroundColor: "lightgreen", ease: "linear", duration: 0.4}, "<")
    .to(switchHTMLElement, {backgroundColor: "green", ease: "linear", duration: 0.4, onComplete: changeSwitchValue, onReverseComplete: changeMessage, onReverseCompleteParams: [3, 2]}, "<");

t4.set(fill, {border: "6px solid grey", borderRadius: "50%", rotation: 45, delay: 0.1})
