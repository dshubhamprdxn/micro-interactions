...
.fromTo(svgContainer.svgContainerL4, svgStyle,{ xPercent: -255, duration: 0.40 }, "-=0.30s")

.fromTo(list.l1, listStyle,{ width: '180px',height: '64px',background: 'rgba(255,255,255, 1)', paddingTop: 0,
duration: 0.20}, "-=0.45s")
.fromTo(list.l2, listStyle,{ width: '215px',height: '64px',background: 'rgba(255,255,255, 1)', paddingTop: 0,
duration: 0.25}, "-=0.40s")
.fromTo(list.l3, listStyle,{ width: '245px',height: '64px',background: 'rgba(255,255,255, 1)', paddingTop: 0,
duration: 0.30}, "-=0.35s")
.fromTo(list.l4, listStyle,{ width: '275px',height: '64px',background: 'rgba(255,255,255, 1)', paddingTop: 0,
duration: 0.40}, "-=0.30s")
